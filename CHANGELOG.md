...
- CI for all Python suites, UI typechecking/builds, dependency audits, Compose validation, and container builds.
...
- Production-style environments now require `TRUSTED_HOSTS`, `TRUSTED_PROXY_CIDRS`, secure auth cookies, non-placeholder secrets, and initial admin credentials.
